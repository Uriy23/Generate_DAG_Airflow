...
start_airbytename_PP_con_1 = AirbyteTriggerSyncOperator(
         task_id = "name_PP_con_1",
...
start_airbytename_PP_con_2 = AirbyteTriggerSyncOperator(
         task_id = "name_PP_con_2",
         airbyte_conn_id = "airbyte",
...
start_airbytename_PCH_con_2 = AirbyteTriggerSyncOperator(
         task_id = "name_PCH_con_2",
         airbyte_conn_id = "airbyte",
         connection_id ="16e7fe82a-f3e8-4c6e-9899-9c0f84d72099",
         asynchronous=False,
         timeout=3600,
...
start_airbytename_PP_con_1>>start_airbytename_PP_con_2>>run_DBT>>start_airbytename_PCH_con_2